...
export class LeadService {
  ...
  getQualifiedLeads(): Observable<ILead[]> {
    return this.http.get<any>(ApiEndpoint.LEADS + "/qualified/leads");
  }

  getLeadsCountByCustomerId(custId: string): Observable<number> {
    return this.http.get<any>(ApiEndpoint.LEADS + "/count/customer/"+custId);
  }
